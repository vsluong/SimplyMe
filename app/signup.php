        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3 emailForm">
                    <h1 class="col-md-9 col-md-offset-3 ">Signup <a href="login.php"> or Login!</a></h1>
                    
                    <?php echo $result ?>
                    
                    <p class="lead" id="formText">Register for SimplyMe to get customized college events for you.</p>
